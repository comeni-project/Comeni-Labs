...
## Task 1: the submodule replaces the directory
...
- [ ] **Step 1: Record what the directory holds now, to compare against**
...
- [ ] **Step 2: Remove the tracked copy**
...
- [ ] **Step 3: Add the submodule pinned to the tag's commit**
...
- [ ] **Step 4: Confirm `.gitmodules` says exactly this**
...
- [ ] **Step 5: Confirm the bytes did not move**
...
Run: `make verify`
Expected: PASS — 814 fast, 3 slow, 73 guards. `make drift` will report *no drift*: it is
comparing the submodule against `../comeni-registry`, which is the same content. Task 3 deletes
it.
...
## Task 2: an empty registry refuses legibly
...
- [ ] **Step 5: Watch the guard fail on its subject**
...
- [ ] **Step 6: Add the Makefile prerequisite**
...
- [ ] **Step 7: Watch the Makefile guard fail**
...
## Task 3: the drift subsystem is deleted
...
- [ ] **Step 4: Delete the nightly drift job**
...
- [ ] **Step 6: Confirm nothing still calls the deleted tool**
...
## Task 4: the prose, and closing out
...
- [ ] **Step 1: Delete `LICENSE-DATA` and repoint what cites it**
...
- [ ] **Step 2: Redirect registry contributions**
...
- [ ] **Step 4: Append to the journal entry**
...
- [ ] **Step 6: Prove the success criterion in §8 of the spec**
