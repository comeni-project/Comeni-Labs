...
1. **`M0100`–`M0107` → `MD0100`–`MD0107`** across `conformance.py`, `cli.py`,
   ...
   and `CHANGELOG.md`. **`notes/journal/`, `notes/audits/` and
   `notes/plans/2026-08-05-conformance-checking.md` are not touched** — append-only, correct
...
# runbook can cite. See notes/specs/2026-08-07-the-pipeline-file.md §10.
MD0100:
  emitted_by: compiler
  concern: conformance
