...
notes/audits/guard-ledger.md   NEW — append-only revert ledger                 I
```
...
**Files:** Modify `notes/audits/guard-ledger.md`.
...
**Files:** `notes/audits/2026-08-07-round-two-audit.md`.
...
**Files:** Create `notes/audits/guard-ledger.md`.
