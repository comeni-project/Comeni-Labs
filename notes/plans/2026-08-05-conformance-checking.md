...
> order in [`notes/README.md`](../README.md). Implements
...
- Modify: `notes/plans/2026-08-02-mendel-ai-and-forge.md` — the forge depends on this
- Modify: `notes/README.md`, `CLAUDE.md`, `CHANGELOG.md`, `docs/reference/cli.md`
...
In `notes/plans/2026-08-02-mendel-ai-and-forge.md`, before Task 8 (`nf-core meta.yml
ingestion`), add:
...
`notes/README.md` — Plan 1.6 becomes complete, Plan 1.7 becomes next.
...
Follow `notes/journal/README.md`. Record which of the five Plan 1.5 defects are now
