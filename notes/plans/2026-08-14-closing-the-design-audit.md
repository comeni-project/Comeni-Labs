...
**Spec:** [`notes/audits/2026-08-14-design-audit.md`](../audits/2026-08-14-design-audit.md)
...
the branch. Then append a row to `notes/audits/guard-ledger.md` naming the guard, what
...
git add packages/comeni-core/src/comeni_core/pipeline.py \
        ...
        tests/test_join.py tests/conftest.py notes/audits/guard-ledger.md
...
row to `notes/audits/guard-ledger.md`.

- [ ] **Step 7: Commit**

```bash
git add packages/mendel-resolver/src/mendel_resolver/router.py \
        tests/test_registry_layer.py notes/audits/guard-ledger.md
...
git add packages/comeni-core/src/comeni_core/decision.py \
        ...
        tests/test_upgrade.py notes/audits/guard-ledger.md
...
`notes/journal/YYYY-MM-DD.md`, append-only, carrying what shipped, what was corrected
