...
- **Arguing with a decision that was made deliberately and recorded.** `notes/README.md`
...
- **Plan 2 opens three of the four doors.** Read `notes/plans/2026-08-02-mendel-ai-and-forge.md`
...
5. `notes/journal/2026-08-13.md`, then backwards as far as patience allows. It carries
...
`notes/audits/2026-08-14-design-audit.md`, in the house shape: a findings table with
...
- **This does not reopen the A14 loop.** A14 is carried by decision (2026-08-13,
  `notes/README.md`). This audit's findings shape **Plan 2**, or they justify a design
