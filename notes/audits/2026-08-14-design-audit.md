...
`attempts/` becomes `notes/audits/fixtures/rule-attempts/`, and a genuine pre-1.13
`pipeline.yml` becomes `notes/audits/fixtures/pipeline-v1.yml` — the only honest input to
