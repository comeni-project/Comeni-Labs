...
| `notes/README.md:129` | "sixteen new diagnostics (`MD0108`, `MD0202`–`MD0203`, `MD0206`–`MD0216`)" | that list is 14 entries and 13 real codes |
| `notes/README.md:105` | "fourteen diagnostics arrive" | contradicts line 129 in the same file |
