...
| 17h | [`2026-08-19-plan-3a-phase-6.md`](plans/2026-08-19-plan-3a-phase-6.md) + [`../specs/2026-08-19-sources-and-drafting.md`](specs/2026-08-19-sources-and-drafting.md) | **PLANNED 2026-08-19, not started.** Sources and drafting: what each source can read, what has been done with each tool, and starting a draft without a terminal. It **designs** a screen `forge-review.md` §9 lists as undesigned. Its audit found four things, and two are defects older than the phase: the forge's mounted transport takes filesystem paths from an unauthenticated request and is **deleted, not just unmounted** — zero consumers, an optional extra nothing installs, and a guide section telling operators to mount it; and `Workspace.save` has overwritten a draft silently since forge phase 1. A fifth was caught in the plan's own test — a boundary check that iterated `app.routes` found **zero** request bodies and would have passed vacuously |
