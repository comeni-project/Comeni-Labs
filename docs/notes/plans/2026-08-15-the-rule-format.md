...
**Spec:** [`notes/specs/2026-08-15-root-5-the-rule-format.md`](../specs/2026-08-15-root-5-the-rule-format.md).
...
- **Every guard is watched failing.** Each task's final step reverts its own guard, watches it
  fail, restores it, and appends a row to `notes/audits/guard-ledger.md`. That is A14's
...
>
> The v2 fixture the plan asks for does not exist; `notes/audits/fixtures/pipeline-v1`
...
`notes/audits/fixtures/rule-attempts/` says its value is recording what the format could
