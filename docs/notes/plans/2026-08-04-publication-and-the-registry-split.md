...
> order in [`notes/README.md`](../README.md), which is also where the reason for that
...
`docs/guides/` and `docs/reference/` mention it. `notes/plans/` is a dated log and is
left alone.
...
Follow `notes/journal/README.md`. Record what shipped, what was corrected in this plan
