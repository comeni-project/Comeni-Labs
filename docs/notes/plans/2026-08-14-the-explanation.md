...
- **Every task ends with a recorded revert** in `notes/audits/guard-ledger.md`. That is
...
```python
LEGACY = "notes/audits/fixtures/pipeline-v1.yml"   # commit one; see step 4
...
**Keep — `notes/audits/fixtures/pipeline-v1.yml`.** A pipeline built at `346eeac`,
...
**Keep — `notes/audits/fixtures/rule-attempts/`.** The twenty rules from
