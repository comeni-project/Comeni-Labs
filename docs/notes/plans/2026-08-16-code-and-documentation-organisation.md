...
**Spec:** [`notes/specs/2026-08-16-code-and-documentation-organisation.md`](../specs/2026-08-16-code-and-documentation-organisation.md).
...
in `notes/audits/guard-ledger.md` under a new heading
...
## Task 7: the diagnostics get their own page — **done**
...
- [x] **Step 1: Point the generator at the new file**
...
- [x] **Step 2: Replace the table in `cli.md` with a pointer**
...
- [x] **Step 4: Watch the freshness check fail**
...
- the `notes/` references are `notes/`
