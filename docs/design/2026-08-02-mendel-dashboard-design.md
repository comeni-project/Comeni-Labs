...
**Mockup:** [`mendel-dashboard.html`](mendel-dashboard.html) — open it directly in a browser; self-contained, no build step.

This is the visual and interaction spec for the builder screen described in
[Plan 3](../superpowers/plans/2026-08-02-mendel-api-and-dashboard.md), Tasks 6–8. Where
