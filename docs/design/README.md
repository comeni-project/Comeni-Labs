...
| [execution-boundary.md](execution-boundary.md) | **what Mendel hands to Wiener** — task vs run scheduling, the two kinds of run, why the executor stays out of the artifact, and local/k8s/AWS | no — the gate exists, the executor profiles and Wiener do not |
