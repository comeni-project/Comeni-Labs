...
> This spec lives in `docs/internal/specs/` and Task 6 moves that directory to `notes/specs/`.
...
`docs/internal/` is 69 of the 94 markdown files under `docs/` and is most of the bloat a
...
| 6 | `docs/internal/` → `notes/`; links repaired; checker into `make check` | the checker, run |
