...
(`docs/internal/README.md`, "Why that order"). Recorded rather than quietly dropped, because
...
- **Every guard this plan writes or repairs needs a row in
  `docs/internal/audits/guard-ledger.md`** — reverted, watched failing, restored, recorded.
...
Append a row to `docs/internal/audits/guard-ledger.md` under a new `## Round four fixes (Plan
...
git add packages/comeni-core/src/comeni_core/pipeline.py \
        ...
        docs/reference/cli.md docs/internal/audits/guard-ledger.md
...
```bash
git add tests/test_purity.py docs/internal/audits/guard-ledger.md
...
```bash
git add tests/test_purity_runtime.py docs/internal/audits/guard-ledger.md
...
```bash
git add tests/test_egress.py docs/internal/audits/guard-ledger.md
...
git add packages/mendel-compiler/src/mendel_compiler/cli.py \
        packages/comeni-core/src/comeni_core/diagnostics.yml \
        tests/test_publish.py docs/reference/cli.md docs/internal/audits/guard-ledger.md
...
- Modify: `docs/internal/README.md` (the plan table and "Why that order")
- Create: `docs/internal/journal/2026-08-13.md`
- Modify: `docs/internal/audits/guard-ledger.md` (the round-four-fixes section header, if Task 1
  did not create it)
...
otherwise is the exact drift `docs/internal/audits/` exists to catch.
...
`docs/internal/audits/2026-08-11-round-four-audit.md`. Label them `audit` and
`round-four`.
...
In `docs/internal/README.md`, under "Why that order", add a dated subsection stating: the
...
`docs/internal/journal/2026-08-13.md`, following the shape of `2026-08-10-evening.md`: what
