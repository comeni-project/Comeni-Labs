...
**Files:**
- Modify: `docs/internal/README.md` — execution order
- Modify: `docs/internal/plans/2026-08-02-mendel-ai-and-forge.md` — the parameters task
...
`docs/internal/README.md`, replace the plans table:
...
Follow `docs/internal/journal/README.md`. Record the emptiness/deadness distinction, why the
