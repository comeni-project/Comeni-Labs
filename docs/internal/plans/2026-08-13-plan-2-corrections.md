...
`docs/internal/README.md` has said since 2026-08-05 that Plan 2 "predates the types it references;
...
`docs/internal/README.md` flagged this collision when Plan 1.7 was written:
