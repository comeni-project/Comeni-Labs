...
Nextflow 25.10.4 (gate target). Design authority: `docs/internal/specs/2026-08-10-closing-round-three.md`.
...
- **Every refusal added or restored earns a guard-ledger row, reverted and watched.** Append to
  `docs/internal/audits/guard-ledger.md`: break the code, run the guard, paste what you saw, restore.
...
- Ledger: `docs/internal/audits/guard-ledger.md`
...
**Files:**
- Test: `tests/test_pipeline_file.py`, `packages/mendel-compiler/tests/test_emit.py`
- Ledger: `docs/internal/audits/guard-ledger.md` (six rows)
...
**Files:**
- Modify: `CLAUDE.md`, `CHANGELOG.md`, `docs/internal/README.md`, `docs/design/clinical-data-protection.md`, `docs/reference/pipeline-schema.md`, and issue #18's text
...
- [ ] **Update `docs/internal/README.md`** order table: Plan 1.11 complete, round four next.
- [ ] **Journal entry** `docs/internal/journal/2026-08-<dd>.md`: what shipped, what each task corrected in this plan (every prior plan needed corrections — record them inline), and that a round-four audit is still owed because the loop exits on *no critical surviving*, not on an empty audit.
