...
| §5's constraints | analysis, implementation and repair are written and each constraint is asserted by the phrase that carries it. **The chat prompt is deliberately absent** and a test says so — see the open question below |
