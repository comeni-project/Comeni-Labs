...
**Status:** **COMPLETE — 2026-09-06**, merged to `main` from `.claude/worktrees/forge-mvp`.

Read [`notes/journal/2026-09-06-the-forge-runs.md`](../../notes/journal/2026-09-06-the-forge-runs.md)
rather than this file for what the forge does now, what it still cannot do, and the nine defects
that only appeared when somebody drove the loop with real upstream data and a real model.

**One box below is deliberately unticked** — *demonstrate the weak-evidence fixture remains
unresolved*. It was not done, and a tick nobody watched being executed is a claim rather than a
record.
