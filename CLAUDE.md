...
| ~~41~~ | code and documentation organisation | **closed 2026-08-16.** Eleven tasks, three emitted digests unmoved. `comeni_core` is five subpackages by lifecycle stage, `docs/internal/` is `notes/`, and `make links` checks every relative link in `docs/` and the root |
