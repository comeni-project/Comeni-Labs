...
**The mapping is the derivability audit (since removed), implemented literally.**
...
Every entry is a `derived` row in the derivability audit (since removed). Adding
...
def scaffold_for(obs: Observation, stack: Layers, *, ident: str, version: str) -> Scaffold:
    ...
    # the derivability audit (since removed) measures it.
