...
const out = { name: "bam", type_id: "alignment.bam", side: "out" as const, met: true, states: [], gathers: false };
const inp = { name: "bam", type_id: "alignment.bam", side: "in" as const, met: false, states: [], gathers: false };
